  ...
  return (
    <main className="min-h-screen bg-[#09090b] pb-24 text-white lg:pb-0">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-6 pt-6 sm:px-6 sm:pb-8 sm:pt-9 lg:px-8">
          <motion.div
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3 sm:gap-6">
              <h1 className="min-w-0 flex-1 text-[1.8rem] font-black leading-[1.15] tracking-tight text-white sm:text-[3.25rem] lg:text-[4rem]">
                Fresh blends<br />
                made for the{" "}
              ...
              <DrinkVisual className="h-[5.5rem] w-[5.5rem] flex-shrink-0 sm:h-40 sm:w-40 md:h-48 md:w-48 lg:h-64 lg:w-64" />
            </div>
            ...
            <div className="mt-1 grid grid-cols-3 gap-2 sm:mt-2 sm:gap-3">
                    ...
                    <div className="mt-2.5 flex items-center justify-between gap-2 border-t border-white/10 px-3.5 py-2.5 sm:mt-4 sm:p-4">
                      <div className="flex items-center gap-1.5 rounded-full bg-black/25 px-1.5 py-1 sm:gap-2 sm:bg-black/20 sm:px-2">
                        <button
                          ...
                          className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-base text-white transition hover:bg-white/20 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 sm:h-8 sm:w-8 sm:text-lg"
                        >
                          −
                        </button>
